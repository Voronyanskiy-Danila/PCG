...
public:
    ...
    virtual void* Allocate(size_t Size, const char* dbgDescription, const char* dbgFileName, const int32_t dbgLineNumber) override;

    /// Releases memory
    virtual void Free(void* Ptr) override;

    /// Allocates block of memory with specified alignment
    virtual void* AllocateAligned(size_t Size, size_t Alignment, const char* dbgDescription, const char* dbgFileName, const int32_t dbgLineNumber) override;
