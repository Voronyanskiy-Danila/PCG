...
#include "dxlib/Diligent/Align.hpp"
...
void* DefaultRawMemoryAllocator::Allocate(size_t Size, const char* dbgDescription, const char* dbgFileName, const int32_t dbgLineNumber)
{
    assert(Size > 0);
...
void* DefaultRawMemoryAllocator::AllocateAligned(size_t Size, size_t Alignment, const char* dbgDescription, const char* dbgFileName, const int32_t dbgLineNumber)
{
